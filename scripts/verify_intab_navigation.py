...
if __name__ == "__main__":
    ...
    # Clean locks
    prof_dir = os.path.expandvars(r"%LOCALAPPDATA%\Qaulium\Profile")
    ...
    # Launch directly at qualium://bookmarks
    print("[+] Launching QualiumQuantumBrowser at qualium://bookmarks...")
    proc = subprocess.Popen([exe, "-url", "qualium://bookmarks"])
    time.sleep(6)

    out_file = r"C:\Users\mndab\.gemini\antigravity-ide\brain\38ef44a2-12b9-4657-8f35-3220c9d8b70b\qualium_v5_bookmarks_intab.png"
    capture_screenshot(out_file)

    # Also test navigating to qualium://settings
    print("[+] Launching QualiumQuantumBrowser at qualium://settings...")
    subprocess.run([exe, "-url", "qualium://settings"], check=False)
    time.sleep(4)

    out_settings = r"C:\Users\mndab\.gemini\antigravity-ide\brain\38ef44a2-12b9-4657-8f35-3220c9d8b70b\qualium_v5_settings_intab.png"
    capture_screenshot(out_settings)
